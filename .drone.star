...
def build_env(ctx):
    ...
    if BUILD_DIST:
        env.update({
            ...
            "NOTARY_BINARY_URL": "https://macos-notary-1628249594.s3.amazonaws.com/releases/client/v3.8.3/linux_{}.zip".format(BUILD_PIPELINE_ARCH),
            "NOTARY_URI": "https://dev.macos-notary.build.10gen.cc/api",
